...
# Simulate profit reaching 700
pos.max_pnl_reached = 700.0
...
print('Dynamic trailing SL after 700 P&L:', pos.dynamic_trailing_sl)
print('Exit reason (should be None):', exit_reason)
